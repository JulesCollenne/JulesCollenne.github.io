...
export const dict = {
  en: {
    ...
    tagline:
      "I build applied AI self-supervised vision, medical imaging, and production ML systems.",
    nav_about: "About",
    nav_news: "News",
    ...
    about_p1:
      "Hey there! I design new ML models, deploy them, and make pipelines more efficient with AI! ",
    about_p2:
  ...
  tagline:
    "Je conçois de l’IA appliquée : vision auto-supervisée, imagerie médicale et systèmes ML en production.",
  nav_about: "À propos",
  nav_news: "Actualités",
  nav_pubs: "Publications",
  ...
  about_p1:
    "Je conçois de nouveaux modèles de ML, je les déploie et j’améliore l’efficacité des pipelines grâce à l’IA.",
  about_p2:
